                      ...
                      {(item.status === "low" || item.status === "out_of_stock") && (
                        <>
                          {isMyTurn(item) ? (
                            ...
                            <div className="flex-1 text-center py-2 px-3 rounded-lg bg-gray-100 border border-gray-200 text-gray-400 text-[11px] font-medium select-none flex items-center justify-center">
                              ⏳ Chờ {nextBuyerName} mua
                            </div>
                          )}
                          {item.status === "low" && (
